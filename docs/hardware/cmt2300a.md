...
The connection pins from the CMT2300A module to the ESP32 module can be dynamically configured using [Device Profiles](../firmware/device_profiles.md) (prefered method) or at compile time.
